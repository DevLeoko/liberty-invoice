...
export type ReplaceConst<T> = T extends string ? string : { [K in keyof T]: ReplaceConst<T[K]> }
...
export function translateShared(locale: Locale, key: ServerTranslationPath, vars?: any) {
